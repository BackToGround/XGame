...
[CustomEditor(typeof(SgtStarfieldFadeNear))]
public class SgtStarfieldFadeNear_Editor : SgtEditor<SgtStarfieldFadeNear>
{
...
[ExecuteInEditMode]
[AddComponentMenu(SgtHelper.ComponentMenuPrefix + "Starfield Fade Near")]
public class SgtStarfieldFadeNear : MonoBehaviour
{
	...
	{
		var importer = SgtHelper.ExportTextureDialog(generatedTexture, "Starfield Fade Near");
	...
	public void UpdateTextures()
	{
		if (Width > 0)
		{
			...
			if (generatedTexture == null)
			{
				generatedTexture = SgtHelper.CreateTempTexture2D("Starfield Fade Near (Generated)", Width, 1, Format);
	...
	public void UpdateApply()
	{
		if (Starfield != null)
		{
			Starfield.FadeNearTex = generatedTexture;

			Starfield.UpdateFadeNearTex();
		}
	}
